...
bool areColliding(GameState gameState)
{
  ...
  if (gameState.player.x + gameState.player.width / 2 < gameState.cactus.x - gameState.cactus.width / 2)
    return false;
  if (gameState.player.x - gameState.player.width / 2 > gameState.cactus.x + gameState.cactus.width / 2)
    return false;
  if (gameState.player.y + gameState.player.height / 2 < gameState.cactus.y - gameState.cactus.height / 2)
    return false;
  if (gameState.player.y - gameState.player.height / 2 > gameState.cactus.y + gameState.cactus.height / 2)
    return false;
